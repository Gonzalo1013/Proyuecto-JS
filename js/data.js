...
$("document").ready(function (){
    ...
    $.ajax({
        ...
        url: APIURL,
        success: function (res) {
            for(const {casa} of res){
                if(casa.nombre === "Dolar Oficial" || casa.nombre === "Dolar Blue") {
            $(".cotizacionDolar").prepend(`<div class="contentDolar">
                                                <h3>${casa.nombre}</h3>
                                                <div class="contentPrice">
                                                    <p>Compra: <b>${casa.compra}</b></p>
                                                    <p>Venta: <b>${casa.venta}</b></p>
                                                </div>
